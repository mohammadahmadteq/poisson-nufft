...
\includegraphics[width=3cm]{Images/LogoUniBayreuth}
\par\vspace{2cm}
...
\begin{center}
	{\huge\bfseries Benchmarking Numerical Methods for Electron Repulsion Integrals \par}
	\vspace{1cm}

	{\Large \bfseries Quantum Chemistry Algorithms Practical Project Report \par}
	{\large at \par}
	{\Large \bfseries University of Bayreuth \par}
    \vspace{4cm}

	{\large \begin{tabbing}
	 \quad \qquad \qquad \qquad \qquad\= by Mohammad Ahmad\\
	 \quad \qquad \qquad \qquad \qquad\= Supervised by Dr. Johannes Margraf\\
	 \quad \qquad \qquad \qquad \qquad\= 16 March 2026\\
	 \end{tabbing}}
